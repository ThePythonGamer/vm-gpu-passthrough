...
VM_NAME="win11"
XML_FILE="$ROOT_DIR/win11-outlawsHV-nohuge.xml"
STARTUP_HOOK="$ROOT_DIR/hooks/profiles/outlawsHV-nohuge/vfio-startup"
TEARDOWN_HOOK="$ROOT_DIR/hooks/profiles/outlawsHV-nohuge/vfio-teardown"
...
echo "Activated $VM_NAME with win11-outlawsHV-nohuge.xml and no-hugepage hooks."
